...
export const UserMatchHistory = () => {
    ...
    useEffect(() => {
        ...
        console.log('data 받음  1');
    }, [start]);



    useEffect(() => {
        console.log('loaded 되서 들어옴  2');
    ...
    const startChange = () => {
        console.log('start change 함수 들어옴')
        setStart(start + 3)
    }
            ...
            <div className={pageLoading ? 'laoding-page' : 'matchHistory-page'}>
                {
                    pageLoading ?
                        ...
                        <div>
                            ...
                            <div>
                                <button onClick={() => { startChange() }}>button</button>
                            </div>
                        </div>
