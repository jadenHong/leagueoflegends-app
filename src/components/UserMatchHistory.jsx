                    ...
                    pageLoading ?
                        ...
                        <div>
                            ...
                            <div className="load-data-button">
                                {loadMore ? <LoadMore className="load-button" /> : <button className="load-button" onClick={() => handleStartClicked()}>button</button>}
...
//                             <div className="load-data-button">
//                                 <button className="load-button" onClick={() => handleStartClicked()}>{`button`}</button>
//                             </div>
